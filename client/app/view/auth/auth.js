...
.controller('AuthController', ['$scope', '$route', 'Auth', '$cookies','$location', 'Cookie', '$window', '$rootScope', function($scope, $route, Auth, $cookies, $location, Cookie, $window, $rootScope) {

  $scope.user = null;

	// Check cookies for user connexion information
  var cookie = $cookies.get('Application-Cookie');
